<section class="container mt-5 mb-5 p-5">
    ...
    <div class="mt-1 row episode">
        <div class="w-100 p-2 d-flex justify-content-between align-items-center">
            <i class="fas fa-hand-point-right d-none d-md-inline"></i>
            <h5 id="arc_<?= $arc->id() ?>" class="p-1 text-center" onclick="EventEpisode.EventFirstClick(<?= $arc->id() ?>)"><?= $arc->title() ?></h5>
            <i class="fas fa-hand-point-left d-none d-md-inline"></i>
        </div>
        <!--===============================================================================================-->
        <div class="row divEpisode w-100 p-1" id="arc_<?= $arc->id() ?>_episodes">
            ...
            <div class="col-12 mt-1">
                <div class="w-100 p-2 d-flex flex-column align-items-center selectEpisode">
                    <div class="w-100 p-2 d-flex justify-content-between align-items-center">
                        <h5><a href="Episode&id=<?= htmlspecialchars($episode->id()) ?>"><?= htmlspecialchars($episode->title()) ?></a></h5>
